...
const providerCommonStep: OnboardingStep = {
  ...
  fields: [
    ...
    },
    {
      ...
      hint: "We will verify this with an OTP",
    },
    {
      id: "email",
    ...
    { id: "profilePhoto", label: "Profile Photo", type: "file" },
    {
      ...
      type: "textarea",
      required: true,
      placeholder: "Area, landmark, town",
      hint: "Map pin-drop coming soon — describe your location for now",
    },
    {
      id: "govIdType",
      ...
      type: "select",
      required: true,
      options: ["Aadhaar", "Voter ID", "Driving License"],
    },
    {
      id: "govIdUpload",
    ...
    {
      id: "yearsInBusiness",
      label: "Years in business / operation",
      type: "number",
      required: true,
      placeholder: "e.g. 5",
    },
    {
      ...
      type: "multi",
      required: true,
      options: ["Nepali", "Bengali", "Hindi", "English"],
    },
  ],
};
  ...
  driver: [
      ...
      fields: [
        {
          ...
          type: "select",
          required: true,
          options: ["Sedan", "SUV", "Shared Jeep", "Bike"],
        },
        {
          id: "regNumber",
        ...
        {
          id: "vehiclePhotos",
          label: "Vehicle photos (front + interior)",
          type: "file",
          multiple: true,
          required: true,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        {
          id: "speaksEnglish",
          label: "Do you speak English with tourists?",
          type: "toggle",
        },
        {
          id: "availability",
          ...
          type: "radio",
          required: true,
          options: ["Full-time", "Weekends", "On-call"],
        },
      ],
    },
    {
      ...
      title: "Verification",
      subtitle:
        'These can be added later — your profile will show as "Unverified" until reviewed',
      fields: [
        {
          id: "policeVerification",
          label: "Police verification certificate (optional)",
          type: "file",
          hint: 'Can be submitted later — status stays "pending"',
        },
        {
          id: "reference",
          label: "Reference contact",
          type: "text",
          placeholder: "Another driver or local business (name + phone)",
        },
      ],
    },
  ],
  ...
  homestay: [
    ...
    },
    {
      ...
      fields: [
        {
          id: "tradeLicense",
          label: "Trade license / homestay registration number",
          type: "text",
          hint: "West Bengal Tourism registration if applicable",
        },
        {
          id: "ownershipProof",
          label: "Ownership proof or rental agreement (upload)",
          type: "file",
        },
      ...
      fields: [
        {
          ...
          type: "text",
          placeholder: "e.g. 12pm check-in, 10am check-out",
        },
        {
          id: "meals",
          label: "Meals offered",
          type: "radio",
          required: true,
          options: ["Breakfast only", "All meals", "None"],
        },
        ...
        { id: "familyFriendly", label: "Family-friendly?", type: "toggle" },
        {
          ...
          type: "textarea",
          placeholder: "e.g. Free cancellation up to 48h before check-in",
        },
      ],
    },
  ],
    ...
    providerCommonStep,
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: "Menu (upload)",
          type: "file",
          hint: "A photo or PDF of your menu",
        },
        {
          id: "photos",
          label: "Photos (interior, signature dishes)",
          type: "file",
          multiple: true,
          required: true,
        },
      ...
      fields: [
        {
          ...
          type: "text",
          required: true,
          placeholder: "e.g. 8am – 9pm, closed Tuesdays",
        },
        {
          id: "specialties",
          label: "Specialties / must-try items",
          type: "textarea",
          placeholder: "e.g. Churpee momos, house-roasted coffee",
        },
        {
          id: "serviceMode",
          label: "Service",
        ...
        },
        {
          ...
          type: "text",
          placeholder: "https://…",
          hint: "Helps us cross-verify your business",
        },
      ],
    },
  ],
  ...
  tourist: [
    {
      ...
      subtitle:
        "Takes 30 seconds — helps us show you the right stays, drivers and food",
      fields: [
